    ...
    <div class="p-2 wrapper-scroll transit">
        ...
        <div class="mb-1 d-flex align-items-center">
            ...
            <div class="col-4 d-flex justify-content-center align-items-center">
                <span class="label-text">出荷準備中：{{ exchangeList.length }}件</span>
            </div>
            ...
            <table class="view-scroll t-border">
                ...
                <tbody>
                    <tr v-for="exchange in exchangeList" :key="exchange.id">
                        ...
                        <td class="text-center">{{ displayDate(exchange.answer_slip_date) }}</td>
...
export default {
    ...
    computed: {
        ...
        ...mapState({
            ...
            search: state => state.exchange.shipping_search,
        }),
    },
    watch:{
    ...
    methods: {
        ...
        ...mapMutations('exchange', ['resetShippingSearch']),
        ...
        updateSendDate: async function (event) {
            let payload = {ids: this.getShipmentIds(), send_date: event}
    ...
    created: async function () {
        this.getMasterExchange().then((res) => {
            this.exchange_status = this.master.exchange_status.filter(item => [6, 7, 8, 9, 10].includes(item.id))
        })

                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ds[ngaydangkiem]" class="picker hasDatepicker" autocomplete="off" placeholder="VD: 20-07-2020" maxlength="10" required="" id="dp1711425746992">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="ds[ngayhethan]" class="picker hasDatepicker" autocomplete="off" placeholder="VD: 30-07-2021" maxlength="10" required="" id="dp1711425746993">
                                </td>
                            </tr>
                            <tr>
                                <td>
